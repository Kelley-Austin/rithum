...
| Slice | Status | Doc | Persona served |
| --- | --- | --- | --- |
| ST-21911: Jira Comments Update Salesforce Case | deployed | [view](docs/slices/conv-1780420472030-st-21911-jira-comments-update-salesforce-case.md) | (see file) |
| ST-21919: Update all Child Cases | ready-to-start | [view](docs/slices/conv-1780420460497-st-21919-update-all-child-cases.md) | (see file) |
| ST-21914: Transfer Case | ready-to-start | [view](docs/slices/conv-1780420457448-st-21914-transfer-case.md) | (see file) |
| ST-21906: Notify Account Team | in-progress | [view](docs/slices/conv-1780420111781-st-21906-notify-account-team.md) | (see file) |
