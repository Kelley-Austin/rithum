...
- **2026-06-02** — _from [ST-21919: Update all Child Cases](docs/slices/conv-1780420460497-st-21919-update-all-child-cases.md)_ — **Chatter posts to child cases are batched into a single collection insert, not one create per loop iteration** — *Why:* Avoids per-record DML calls that would hit governor limits on cases with many children.
